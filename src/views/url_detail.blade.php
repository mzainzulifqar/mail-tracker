...
@section(config('mail-tracker.admin-template.section'))
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-2">
                <h1>
                    <a href="{{siteRoute('mailTracker_Index',['page'=>session('mail-tracker-index-page')])}}" class='btn btn-default'>All Sent Emails</a>
                </h1>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <a href="{{ siteRoute('mailTracker_ShowEmail',['id' => $details->first()->email->id]) }}" class="btn btn-default" target="_blank">
                    View Message
                </a>
            </div>
        </div>
